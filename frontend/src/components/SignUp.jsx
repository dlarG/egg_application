...
function SignUpForm({ onSuccess, isMobile = false }) {
  ...
  const containerClasses = isMobile
    ...
    : "absolute top-0 left-0 w-1/2 h-full opacity-0 z-[1] transition-all duration-[600ms] ease-in-out sign-up-container";
    ...
    <div className={containerClasses}>
      <form onSubmit={handleOnSubmit} className={formClasses}>
        ...
        <span className="font-light text-sm sm:text-base leading-6 mb-4 text-[#A0D585]">
          Use your credentials for registration
        </span>
